...
Nous pouvons enfin afficher le **MAPE** de ces GAMs par heure, et le comparer à la prévision *dayahead* de **RTE**.
...
On observe que les GAMs par heure sont à peu près aussi bons que la prévision de RTE, et nettement meilleurs que **gtot**, dont le MAPE oscillait entre 2 et 3%.
